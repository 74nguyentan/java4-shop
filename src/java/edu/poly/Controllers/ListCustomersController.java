 ...
 * @author exfic
 */
@WebServlet(name = "ListCustomersController", urlPatterns = {"/ListCustomersController"})
  ...
  *
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher rd  = request.getRequestDispatcher("backend/customers/list.jsp");
