 ...
 * @author exfic
 */
@WebServlet(name = "EditCartDetailController", urlPatterns = {"/EditCartDetailController"})
public class EditCartDetailController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            CartDetail entity = ddao.findCartDetailById(Integer.parseInt(id));
            request.setAttribute("cartDetail", entity);
